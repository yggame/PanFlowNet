...
from metricsutil import get_metrics_reduced
#torch.from_numpy
#torch.float()
...
path_ms = "/media/manman/data_disk/yaogan/WV2_data/test128/ms"
path_pan = "/media/manman/data_disk/yaogan/WV2_data/test128/pan"
#path_predict = "/ghome/fuxy/yaogan/WV3_data/test128/predict"
path_predict = "/home/manman/man_code/pan_gcn_inn-WV2/results/pan_gcn_inn_WV2/test"
...
for file_name_i in list_name:
    ...
    fused_image = np.float32(fused_image)
